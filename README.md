This project is scaffolded with Nx. The majority of the below is from the autogenerated documentation.

In order to run the entire project in a local development environment, run `up.sh`
...
Libraries are shareable across libraries and applications. They can be imported from `@opentech-radar/mylib`.
